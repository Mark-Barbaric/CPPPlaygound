...
namespace GraphAlgorithms{
    ...
    bool containsCycleAndDistanceUtil(int u, std::vector<int>& visited, std::vector<std::list<int>>& adj,
                                      std::vector<int>& dp){
        ...
        for(auto it = adj[u].begin(); it != adj[u].end(); ++it){
            ...
            if(visited[*it] == 0 && containsCycleAndDistanceUtil(*it, visited, adj, dp)){
                return true;
            }

            //      dp[u] = std::max(dp[u], dp[*it] + 1);
    ...
    int minimumSemesters(int n, std::vector<std::vector<int>>& relations) {
        ...
        for(int i = 0; i < relations.size(); ++i){
            ...
            if(visited[i] == 0 && containsCycleAndDistanceUtil(i, visited, adj, dp)){
                return -1;
            }
            std::cout << std::endl;
