...
namespace Algorithms::Backtracking{
    ...
    TEST(BacktrackingTests, SudokuSolverTests)
    {
        ...
        std::vector<std::vector<int>> result = { {3, 1, 6, 5, 7, 8, 4, 9, 2},
                                                 {5, 2, 9, 1, 3, 4, 7, 6, 8},
                                                 {4, 8, 7, 6, 2, 9, 5, 3, 1},
                                                 {2, 6, 3, 4, 1, 5, 9, 8, 7},
                                                 {9, 7, 4, 8, 6, 3, 1, 2, 5},
        ...
        EXPECT_TRUE(Sudoku_Solver::solveSudoku(grid));
        EXPECT_EQ(grid, result);
    }
}